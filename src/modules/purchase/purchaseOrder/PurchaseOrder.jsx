                    ...
                    <Container className="mt-2" fluid>
                        <Row>
                            ...
                            <Form.Group as={Col} md="4" className="mb-2">
                                ...
                                />}
                                {errors.vendor?.message && <p style={{ color: "red" }}>{errors.vendor?.message}</p>}
                            </Form.Group>
                            <Form.Group as={Col} md="4" className="mb-2">
                                                                        ...
                                                                        (
                                                                            <Typeahead
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    ...
                                                                                    setValue(`products.${index}.product`, e[0]?.name);
                                                                                    // setValue(`products.${index}.name`, e.name);
                                                                                    setValue(`products.${index}.description`, e[0]?.description);
                                                                                    setValue(`products.${index}.unitPrice`, e[0]?.cost);
