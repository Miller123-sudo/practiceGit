...
export default function OutstandingReceipt() {
    ...
    const handlePrintReceiptReport = async () => {
        ...
        doc.text("Outstanding Receipt Report", 190, 50);
        ...
        doc.save(`Outstanding Receipt Report - ${state.name}.pdf`);
    }
    ...
    useEffect(async () => {
        ...
        const readyOutstandingReceiptData = response.data.documents.filter(element => element.status === 'Ready');
        setstate(readyOutstandingReceiptData)
        ...
        <Container className="pct-app-content-container p-0 m-0" fluid>
            <Container className="pct-app-content" fluid>
                <Container className="pct-app-content-header p-0 m-0 pb-2" fluid>
                    <Row>
                        <Col><h3>Outstanding Products Receipt Report</h3></Col>
                    </Row>
                    <Row>
                        <Col>
                        ...
                        <Col md="6" sm="6">
                            <Row>
                                ...
                                <Col md="3"><Button onClick={handlePrintReceiptReport} variant="light" size="sm"><span>Export PDF</span></Button></Col>
