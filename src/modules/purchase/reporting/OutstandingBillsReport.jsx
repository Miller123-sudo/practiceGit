...
export default function OutstandingBillsReport() {
    ...
    const handlePrintReportBill = async () => {
        ...
        state.map(item => {
            ...
            newObject.totalPrice = item.total;
        ...
        doc.autoTable({
            ...
            columns: [
                ...
                { header: 'Vendor Name', dataKey: 'vendor' },
    ...
    useEffect(async () => {
        ...
        const readyOutstandingBillData = response.data.documents.filter(element => element.paymentStatus === 'Not Paid');
        setstate(readyOutstandingBillData)
        ...
        <Container className="pct-app-content-container p-0 m-0" fluid>
            <Container className="pct-app-content" fluid>
                <Container className="pct-app-content-header p-0 m-0 pb-2" fluid>
                    <Row>
                        <Col><h3>Outstanding Bills Report</h3></Col>
                    </Row>
                    ...
                    <Row>
                        ...
                        <Col md="6" sm="6">
                            <Row>
                                ...
                                <Col md="3"><Button onClick={handlePrintReportBill} variant="light" size="sm"><span>Export PDF</span></Button></Col>
