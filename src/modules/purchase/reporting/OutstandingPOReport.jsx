...
export default function OutstandingPOReport() {
    ...
    const handlePrintPO = async () => {
        ...
        doc.text("Outstanding PO Report", 190, 50);
        ...
        doc.save(` Outstanding Purchase Order Report - ${state.name}.pdf`);
    }
    ...
    useEffect(async () => {
        ...
        const readyOutstandingPOData = response.data.documents.filter(element => element.billingStatus !== 'Fully Billed' && element.billingStatus !== 'Nothing to Bill');
        setstate(readyOutstandingPOData)
                    ...
                    <Row>
                        ...
                        <Col md="6" sm="6">
                            <Row>
                                ...
                                <Col md="3"><Button onClick={handlePrintPO} variant="light" size="sm"><span>Export PDF</span></Button></Col>
