                ...
                <Container className="pct-app-content-body p-0 m-0 mt-2" fluid>
                    ...
                    <Container className="mt-2" fluid>
                        ...
                        <Row>
                            ...
                            {/* <Form.Group as={Col} md="4" className="mb-2">
                                <Form.Label className="m-0">Product Availability</Form.Label>
                                {getValues('isProductAvailable') ? <Form.Control style={{ color: 'green' }} plaintext readOnly defaultValue="Available" /> 
                                    : <Form.Control style={{ color: 'red' }} plaintext readOnly defaultValue="Not Available" />}
