...
export default function SalesOrderList() {
    ...
    const columns = [
        ...
        { headerName: 'Customer', field: 'customer.name', flex: 1 },
        { headerName: 'Date', field: 'date', flex: 1, valueGetter: (params) => params.data?.date ? moment(params.data?.date).format("DD/MM/YYYY HH:mm:ss") : "Not Available" },
        { headerName: 'Delivery Date', field: 'deliveryDate', flex: 1, valueGetter: (params) => params.data?.deliveryDate ? moment(params.data?.deliveryDate).format("DD/MM/YYYY HH:mm:ss") : "Not Available" },
        { headerName: 'Total', field: 'estimation.total', flex: 1 },
        {
